<script lang="ts">
   ...
   } from '../../stores/shoppingCart/index.ts';
</script>
...
<div>
   <ul class="steps">
      ...
      <li data-content="3" class="step" class:step-primary={currentStep >= Steps.PAYMENT}>Payment</li>
      ...
      {#if $currentStep === Steps.PRODUCTS}
         <div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 flex">
               <button
                  on:click={() => $currentStep.set(Steps.SHIPPING)}
      ...
      {:else if $currentStep === Steps.SHIPPING}
         <div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 flex justify-center">
               <button
                  on:click={() => $currentStep.set(Steps.PRODUCTS)}
               ...
               <button
                  ...
                  on:click={() => $currentStep.set(Steps.PAYMENT)}
